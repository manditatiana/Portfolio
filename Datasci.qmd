...
- Silge, J., & Robinson, D. (2017). *Text Mining with R: A Tidy Approach*. O'Reilly Media. how specific language contributes to the overall themes, I generated additional visualizations. These charts show the most commonly used terms for each sentiment category and help clarify which words most frequently contributed to theme classification. This breakdown supports both transparency and interpretability of the qualitative coding process.
